...
import type { HeaderBlock, EmailBlock } from '@/lib/email-blocks'
...
function LinkDialog({
  ...
  return (
    <div className="flex items-center gap-1.5">
      <Input
        data-testid="inline-header-link-url-input"
        value={url}
      ...
      <button
        type="button"
        data-testid="inline-header-link-save-btn"
      ...
      {current && (
        <button
          type="button"
          data-testid="inline-header-link-remove-btn"
...
export function InlineHeaderEditor({ block, onUpdate }: Props) {
  ...
  const editor = useEditor({
    ...
    content: (() => {
      const t = block.props.text
      if (!t) return '<p></p>'
      if (t.trim().startsWith('<')) return t
      return `<p>${t}</p>`
    })(),
    onUpdate: ({ editor }) => {
      onUpdate({ ...blockRef.current, props: { ...blockRef.current.props, text: editor.getHTML() } })
    },
    editorProps: {
      attributes: {
        class: 'outline-none min-h-[60px] leading-relaxed text-xl font-bold',
        'data-testid': 'inline-header-tiptap-editor',
      },
    },
  })
  ...
  return (
    <div className="rounded-xl overflow-hidden" data-testid="inline-header-editor">
      {/* Toolbar */}
      <div
        className="sticky top-0 z-20 flex flex-wrap items-center gap-0.5 px-2 py-1.5 bg-white border-b border-slate-100 shadow-sm"
        data-testid="inline-header-toolbar"
      >
        {/* Font size */}
        <select
          data-testid="inline-header-font-size-select"
        ...
        {/* Undo / Redo */}
        <ToolbarBtn
          data-testid="inline-header-undo"
        ...
        <ToolbarBtn
          data-testid="inline-header-redo"
        ...
        {/* Text format */}
        <ToolbarBtn
          data-testid="inline-header-bold"
        ...
        <ToolbarBtn
          data-testid="inline-header-italic"
        ...
        <ToolbarBtn
          data-testid="inline-header-underline"
        ...
        <ToolbarBtn
          data-testid="inline-header-strike"
        ...
        {/* Alignment */}
        <ToolbarBtn
          data-testid="inline-header-align-left"
        ...
        <ToolbarBtn
          data-testid="inline-header-align-center"
        ...
        <ToolbarBtn
          data-testid="inline-header-align-right"
        ...
        <ToolbarBtn
          data-testid="inline-header-align-justify"
        ...
        {/* Lists */}
        <ToolbarBtn
          data-testid="inline-header-bullet-list"
        ...
        <ToolbarBtn
          data-testid="inline-header-ordered-list"
        ...
        {/* Link */}
        <ToolbarBtn
          data-testid="inline-header-link"
        ...
        {/* Clear formatting */}
        <ToolbarBtn
          data-testid="inline-header-clear"
        ...
        <div className="flex items-center gap-1" title="Color de texto">
          <input
            data-testid="inline-header-text-color"
            type="color"
        ...
        {/* Background color — block level */}
        <div className="flex items-center gap-1" title="Color de fondo">
          <input
            data-testid="inline-header-bg-color"
            type="color"
      ...
      {/* Link dialog */}
      {showLinkDialog && (
        <div className="px-2 py-1.5 border-b border-slate-100 bg-slate-50/60" data-testid="inline-header-link-dialog">
          <LinkDialog
            current={currentLink ?? ''}
      ...
      <div
        data-testid="inline-header-content"
        className="px-6 py-5 [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5 [&_li]:my-0.5"
        style={{ background: block.props.bgColor }}
      >
        <input
          data-testid="inline-header-subtext-input"
          value={block.props.subtext ?? ''}
          onChange={e => update({ subtext: e.target.value || undefined })}
          placeholder="Subtítulo (opcional)"
          style={{ color: block.props.textColor }}
          className="text-xs font-semibold mb-2 opacity-70 uppercase tracking-wider bg-transparent outline-none border-none w-full placeholder-white/40"
        />
        <div style={{ color: block.props.textColor }}>
