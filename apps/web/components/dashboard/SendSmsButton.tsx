...
import { sendSmsCampaign } from '@/app/dashboard/comunicaciones/sms-actions'
...
export function SendSmsButton({ campaignId, recipientCount }: Props) {
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription render={<div className="space-y-3" />}>
            <p>
              Estás a punto de enviar este SMS a{' '}
            ...
            <div className="flex items-start gap-2 bg-orange-50 border border-orange-200 rounded px-3 py-2.5 text-sm text-orange-700">
              ...
              <span>Esta acción no se puede deshacer. Los destinatarios recibirán el SMS inmediatamente.</span>
            </div>
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
