...
import { Plus, CheckCircle2, Clock, AlertTriangle, ChevronRight, Circle } from 'lucide-react'
...
interface Props {
  campaignId: string
  userId: string
  kpis: { totalTasks: number; completedToday: number; overdueTasks: number }
  myTasks: Task[]
  members: Member[]
}
...
export function OperationsHome({ campaignId, userId, kpis, myTasks, members }: Props) {
