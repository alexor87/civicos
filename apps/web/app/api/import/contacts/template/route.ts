...
const TEMPLATE_COLUMNS = [
  ...
  { header: 'Nivel de Contacto',              key: 'contact_level',      required: false, example: 'completo' },
...
export async function GET(_req: NextRequest) {
  ...
  const instructionRows: string[][] = [
    ...
    ['Nivel de Contacto', 'No', 'completo | opinion | anonimo', 'Si se deja vacío se auto-detecta según los datos del contacto'],
