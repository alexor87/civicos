...
/// Ajustes del voluntario.
/// Nombre canónico esperado por el router: [SettingsScreen].
          ...
          ElevatedButton(
            onPressed: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(
                  content:
                      Text('Enlace enviado a tu correo electrónico.'),
                ),
              );
            },
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            const Icon(Icons.chevron_right, color: AppColors.subtleText, size: 20),
          ],
        ),
      ),
    );
